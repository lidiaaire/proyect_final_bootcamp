...
const policyholderSchema = new mongoose.Schema({
  ...
  // Datos demográficos del asegurado (Sprint documental): permanentes,
  // no dependen de una solicitud concreta -- por eso viven aquí y no en
  // Solicitud. `sexo` usa valores semánticos en vez de M/F para que las
  // plantillas de documento decidan ellas la representación visual.
  fechaNacimiento: {
    type: Date,
  },
